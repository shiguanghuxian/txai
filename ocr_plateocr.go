...
// // image 图片base64后字符串
// func (ai *TxAi) VisionPornForBase64(image string) (*OcrResponse, error) {
...
// 	err := ai.RequestAPI(visionPornURI, params, ocrResponse)
// 	if err != nil {
// 		return nil, err
// 	}
...
// // imagePath 本地图片路径
// func (ai *TxAi) VisionPornForPath(imagePath string) (*OcrResponse, error) {
